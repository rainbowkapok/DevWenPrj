...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=WenDB;Integrated Security=True;encrypt=false;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Category商品類別>(entity =>
        {
            ...
            entity.Property(e => e.CategoryName類別名稱).HasMaxLength(50);
        });
        ...
        modelBuilder.Entity<Member會員>(entity =>
        {
            ...
            entity.Property(e => e.Cid信用卡流水號).HasColumnName("CId信用卡流水號");
            entity.Property(e => e.CreatedTime建立時間).HasColumnType("date");
            entity.Property(e => e.Email信箱).HasMaxLength(50);
            entity.Property(e => e.Gender性別).HasComment("0:女，1:男");
            entity.Property(e => e.Name會員名稱).HasMaxLength(10);
            entity.Property(e => e.Password密碼).HasMaxLength(20);
            entity.Property(e => e.Phone手機號碼).HasMaxLength(30);
            entity.Property(e => e.SessionId).HasComment("SessionId	字串GUID，由作業的發起方產生，以識別此次介接動作的一連串流程");

            entity.HasOne(d => d.Cid信用卡流水號Navigation).WithMany(p => p.Member會員s)
        ...
        modelBuilder.Entity<Order訂單總表>(entity =>
        {
            ...
            entity.HasOne(d => d.OrdStatusId訂單狀態編號Navigation).WithMany(p => p.Order訂單總表s)
                .HasForeignKey(d => d.OrdStatusId訂單狀態編號)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Order訂單總表_OrderStatus訂單狀態");

            entity.HasOne(d => d.StoreId各店編號Navigation).WithMany(p => p.Order訂單總表s)
        ...
        modelBuilder.Entity<Product商品>(entity =>
        {
            ...
            entity.HasOne(d => d.Id類別編號Navigation).WithMany(p => p.Product商品s)
        ...
        modelBuilder.Entity<Receipt購買商品明細>(entity =>
        {
            ...
            entity.HasOne(d => d.Id產品編號Navigation).WithMany(p => p.Receipt購買商品明細s)
                .HasForeignKey(d => d.Id產品編號)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Receipt購買商品明細_Product商品");

            entity.HasOne(d => d.OrdId訂單編號Navigation).WithMany(p => p.Receipt購買商品明細s)
        ...
        modelBuilder.Entity<Store各分店>(entity =>
        {
            ...
            entity.Property(e => e.StoreName店名).HasMaxLength(100);
